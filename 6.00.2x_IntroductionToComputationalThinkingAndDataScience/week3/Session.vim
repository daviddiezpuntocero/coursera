...
inoremap <C-BS> bdwi
imap <F4> :TagbarOpen
imap <S-F4> :TagbarToggle
inoremap <S-F7> :so $HOME/dotfiles/.backup/Session.vim
inoremap <F7> :mksession! $HOME/dotfiles/.backup/Session.vim
map! <F11> :onlyi
map! <S-F11> -i
...
nmap + i r
map ,z :chdir %:p:h :call FindAndRunTarget()
map ,t :call SetBuildTarget()
map ,g :call GetProbFile()
map ,l :call SetLogFile()
map ,f :chdir %:p:h :call DoAntCmd(g:antOption.' -find',g:buildFile) :chdir -
map ,s :call SetBuildFile()
map ,b :call DoAntCmd(g:antOption.' -buildfile',g:buildFile)
nnoremap Q h
vmap Q gq
omap Q gq
...
xnoremap <SNR>113_VisualNrrwBang :call nrrwrgn#VisualNrrwRgn(visualmode(),'!')
xnoremap <SNR>113_VisualNrrwRgn :call nrrwrgn#VisualNrrwRgn(visualmode(),'')
...
map <D-f> :set invfullscreen        " toggle fullscreen mode  free up Command-F
map <C-BS> bdw
nmap <F4> :TagbarOpen 
nmap <S-F4> :TagbarToggle 
map <F8> :execute RotateColorTheme()
map <S-F7> :so $HOME/dotfiles/.backup/Session.vim
map <F7> :mksession! $HOME/dotfiles/.backup/Session.vim
map <C-F11> :call libcallnr("gvimfullscreen.dll", "ToggleFullScreen", 0)
map <F11> :only
map <S-F11> -
vmap <BS> "-d
map!  I
...
set sidescrolloff=5
set smarttab
set statusline=%f%#warningmsg#%{&ff!='unix'?'['.&ff.']':''}%*%#warningmsg#%{(&fenc!='utf-8'&&&fenc!='')?'['.&fenc.']':''}%*%#warningmsg#%{(&bomb)?'[.BOM]':''}%*%h%y%r%m%{fugitive#statusline()}%#error#%{StatuslineTabWarning()}%*%#warningmsg#%{StatuslineTrailingSpaceWarning()}%*%{StatuslineLongLineWarning()}%#error#%{&paste?'[P]':''}%*%=%{StatuslineCurrentHighlight()}\ \ %c,%l/%L\ %P\ %{tagbar#currenttag('[%s]\ ','')}\ %{strftime(\"%l:%M:%S\ %p,\ %a\ %b\ %d\")}\ %{VimBuddy()}
set tabstop=4
set tags=./tags,tags;
set termencoding=utf-8
set updatetime=2000
set viewdir=~/dotfiles/.backup
set virtualedit=all
set visualbell
set wildignore=*.pyc
set window=45
...
silent only
cd ~/Projects/coursera/6.00.2x_IntroductionToComputationalThinkingAndDataScience/week3
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +31 histogramfun.py
badd +0 ~/dotfiles/.vim/config/mapping.vim
badd +4 \'__doc__\'
badd +1 ~/dotfiles/.vim/runtime/rst.vim
badd +0 ~/dotfiles/.vim/runtime/syntax/rst.vim
silent! argdel *
edit ~/dotfiles/.vim/config/mapping.vim
...
silent! normal! zE
let s:l = 145 - ((41 * winheight(0) + 21) / 43)
...
wincmd w
argglobal
edit ~/dotfiles/.vim/bundle/bundle/jedi-vim/doc/jedi-vim.txt
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
xnoremap <buffer> <silent> \a( `>a)`<i(
...
setlocal tabstop=8
setlocal tags=~/dotfiles/.vim/bundle/bundle/jedi-vim/.git/help.tags,~/dotfiles/.vim/bundle/bundle/jedi-vim/.git/tags,./tags,tags;
setlocal textwidth=78
setlocal thesaurus=
setlocal noundofile
setlocal nowinfixheight
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 262 - ((28 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
262
...
setlocal tabstop=8
setlocal tags=~/Projects/coursera/.git/python.tags,~/Projects/coursera/.git/tags,./tags,tags;
...
31
normal! 016|
tabedit ~/dotfiles/.vim/runtime/syntax/rst.vim
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 107 - ((42 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
